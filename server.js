...
// Book.find(({pages: { "$gte": 200, "$lt": 500}})).exec((err, result) => {
//   if (err) {
...
// Book.find({rating: { "$lt": 5}}).sort('author').exec((err, result) => {
//   if (err) {
//     return console.error(err);
//   }
//   console.log(result);
...
// Book.find({genres: "Fiction"}).skip(2).limit(3).exec((err, result) => {
//   if (err) {
//     return console.error(err);
//   }
//   console.log(result);
...
// Person.find({height: {"$gt": 180}, salary: {"$gt": 30000}}).exec((err, result) => {
//   if (err) {
//     return console.error(err);
//   }
//   console.log(result);
...
// Person.find({"$or": [{height: {"$gt": 180}}, {salary: {"$gt": 30000}}]}).exec((err, result) => {
//   if (err) {
//     return console.error(err);
//   }
//   console.log(result);
...
// Person.find({"$or": [{hair: "grey"}, {eyes: "grey"}], weight: {"$lt": 70} }).exec((err, result) => {
//     if (err) {
//       return console.error(err);
//     }
//     console.log(result);
...
// Person.find({kids: {"$elemMatch": {hair: "grey"}}}).exec((err, result) => {
//       if (err) {
//         return console.error(err);
//       }
//       console.log(result);
...
Person.find({kids: {"$elemMatch": {weight: {"$gt": 100}}}}).and({weight: {"$gt": 100}}).exec((err, result) => {
        if (err) {
          return console.error(err);
        }
        console.log(result);
